...
const F1_ZONES = [
  ...
  { type: 'sign', x: 715, y: 270, w: 430, h: 30, label: 'MAIN BOOK STACKS' },
  { type: 'shelf', x: 292, y: 70, w: 72, h: 180, label: 'Fiction Stacks', interact: true, solid: true },
  { type: 'shelf', x: 380, y: 70, w: 72, h: 180, label: 'Fiction Stacks', interact: true, solid: true },
  { type: 'shelf', x: 492, y: 70, w: 72, h: 180, label: 'History Stacks', interact: true, solid: true },
  { type: 'shelf', x: 580, y: 70, w: 72, h: 180, label: 'History Stacks', interact: true, solid: true },
  { type: 'shelf', x: 692, y: 70, w: 72, h: 180, label: 'Science Stacks', interact: true, solid: true },
  { type: 'shelf', x: 780, y: 70, w: 72, h: 180, label: 'Science Stacks', interact: true, solid: true },
  { type: 'shelf', x: 892, y: 70, w: 72, h: 180, label: 'Arts Stacks', interact: true, solid: true },
  { type: 'shelf', x: 980, y: 70, w: 72, h: 180, label: 'Arts Stacks', interact: true, solid: true },
  ...
  { type: 'shelf', x: 446, y: 565, w: 64, h: 142, label: 'Education Books', interact: true, solid: true },

  { type: 'wall_shelf', x: 140, y: 40, w: 900, h: 64, label: 'Featured Book Display', interact: true, solid: true },
  { type: 'wall_shelf', x: 40, y: 170, w: 64, h: 270, label: 'Magazine Shelves', interact: true, solid: true },
  { type: 'wall_shelf', x: 1300, y: 70, w: 220, h: 64, label: 'New Books', interact: true, solid: true },
...
const F2_ZONES = [
  ...
  { type: 'shelf', x: 1112, y: 190, w: 68, h: 128, label: 'Local History Books', interact: true, solid: true },
  { type: 'shelf', x: 1198, y: 190, w: 68, h: 128, label: 'Map Cases', interact: true, solid: true },
  { type: 'shelf', x: 1284, y: 190, w: 68, h: 128, label: 'Rare Books', interact: true, solid: true },
  { type: 'shelf', x: 1370, y: 190, w: 68, h: 128, label: 'Manuscripts', interact: true, solid: true },
  { type: 'shelf', x: 1456, y: 190, w: 68, h: 128, label: 'Archive Stacks', interact: true, solid: true },
  ...
  { type: 'sign', x: 340, y: 318, w: 370, h: 30, label: 'RESEARCH BOOK STACKS' },
  { type: 'shelf', x: 72, y: 70, w: 72, h: 226, label: 'Academic Books', interact: true, solid: true },
  { type: 'shelf', x: 172, y: 70, w: 72, h: 226, label: 'History Books', interact: true, solid: true },
  { type: 'shelf', x: 272, y: 70, w: 72, h: 226, label: 'Science Books', interact: true, solid: true },
  { type: 'shelf', x: 372, y: 70, w: 72, h: 226, label: 'Art Books', interact: true, solid: true },
  { type: 'shelf', x: 472, y: 70, w: 72, h: 226, label: 'Travel Books', interact: true, solid: true },
  { type: 'wall_shelf', x: 80, y: 40, w: 520, h: 64, label: 'Reference Books', interact: true, solid: true },
